var gcObject = {
  ...
  setDate(e) {
    const t = new Date(e);
    t != this.pickedDate &&
      (t > this.pickedDate ? (this.eventAnimate = "next") : (this.eventAnimate = "prev"),
      (this.pickedDate = t),
      this.render());
  },
  setEvents(e) {
  ...
  render() {
    ...
    i.removeClass("slide-in-left slide-in-right slide-out-left slide-out-right"),
      "none" == this.eventAnimate
        // ? i.hide().addClass("slide-in-left").show() 
        ? null
  ...
  getCalendarArray() {
    ...
    for (let e = 1; e < 6; e++) {
      var h = [];
      for (let e = 0; e < 7; e++)
        h.push({ datejs: new Date(d.getFullYear(), d.getMonth(), s), date: s, class: l }),
